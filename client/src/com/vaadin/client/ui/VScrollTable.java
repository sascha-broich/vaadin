...
public class VScrollTable extends FlowPanel
    ...
    private final NativePreviewHandler mouseUpPreviewHandler = new NativePreviewHandler() {
        ...
        public void onPreviewNativeEvent(NativePreviewEvent event) {
            if (event.getTypeInt() == Event.ONMOUSEUP) {
                ...
                // capture is in use
                Element elementUnderMouse = Util
    ...
    public void updateActionMap(UIDL mainUidl) {
        ...
        while (it.hasNext()) {
            ...
            if (action.hasAttribute("icon")) {
                ...
                actionMap.put(key + "_i", client
                        .translateVaadinUri(action.getStringAttribute("icon")));
            } else {
                    ...
                    case Event.ONMOUSEUP:
                        ...
                        if (mouseUpPreviewMatched && lastMouseDownTarget != null
                                && lastMouseDownTarget == getElementTdOrTr(
                                        Util.getElementUnderMouse(event))) {
    ...
    public void onBlur(BlurEvent event) {
        ...
        if (BrowserInfo.get().isIE()) {
            ...
            if (Util.getConnectorForElement(client, getParent(),
                    focusedElement) == this && focusedElement != null
